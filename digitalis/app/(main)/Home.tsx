          ...
          <View style={{ flex: 1, flexDirection: "row" }}>
            ...
            <View>
              ...
              <Text style={FontStyles.MediumText}>
                {Math.floor((2300 - outgoing_index) / 50)} Messages Left
              </Text>
            </View>
          </View>
        </View>
      ...
      <StandardBackground style={UtilityStyles.mainBackground}>
        ...
        >
          ...
          <View>
            <FlatList
              //@ts-expect-error
              renderItem={(key: number, index: number) => (
                <View
                  key={index}
                  style={{
                    margin: 10,
        ...
        >
          ...
          >
            {optionsEnabled && (
              <TouchableOpacity
                ...
                onPress={() => setOptionsEnabled(false)}
              >
            ...
            {optionsEnabled ? (
              ...
              <TouchableOpacity
                ...
                onPress={() => setOptionsEnabled(!optionsEnabled)}
              >
                <FlatList
                  renderItem={(key) => (
                    <View
          ...
          <View style={{ paddingHorizontal: 10, marginTop: 16 }}>
            {contacts[0] == undefined && (
              <Text style={[FontStyles.ExtraSmall, { opacity: 0.6 }]}>
                Looks like you have not added any contacts, Please use the Add
                button to do so.
              </Text>
            )}
            <FlatList
              renderItem={(contactItem) => (
                <ChatCard
                  ...
                  optionSet={optionsEnabled}
                  setOption={setOptionsEnabled}
